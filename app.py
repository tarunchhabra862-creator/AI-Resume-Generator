...
def search_recent_new_jobs(query):
  ...
  suppose user write python Developers jobs
...
with job resume maker ,your tasks is to give
...
Tarun Chhabra
Doing BCA from IITM college
contact no - 987654893
Gmail = tarunchhabra862@gmail.com"""
